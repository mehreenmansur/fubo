...
SimpleForm.setup do |config|
  ...
  config.label_text =
    ->(label, required, _explicit_label) { "#{label} #{required}" }
  ...
  config.wrappers(
    ...
    b.wrapper(
      :form_check_wrapper,
      tag: 'div',
      class: 'custom-control custom-checkbox-switch'
    ) do |bb|
      bb.use(
        :input,
        class: 'custom-control-input',
